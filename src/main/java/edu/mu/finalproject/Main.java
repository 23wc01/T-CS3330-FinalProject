...
public class Main {
	...
	public static void main(String[] args) {
		...
		Song song0 = new Song(0, "The Gummy Bear Song", "gummy bear", new Date(), false, 0, Preference.EDM);
		Song song1 = new Song(1, "Peanut Butter Jelly Time", "peanut",new Date(), false, 0, Preference.RAP);
		Song song2 = new Song(2, "The Guacamole Song", "avocado", new Date(), false, 0, Preference.POP);
		Song song3 = new Song(3, "Hot potato", "potato", new Date(), false, 0, Preference.POP);
